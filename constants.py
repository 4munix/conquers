          ...
          <div class="hosts-nav-content">
            ...
            <div class="nav-stuff">
              <span class="title">conquers
                report</span>
              <div class="logo">
              <img src="https://raw.githubusercontent.com/4munix/ghcdn/refs/heads/main/conquers/logo.svg" width=144 alt="logo">
              </div>
    ...
    HTML_BOTTOM = '''
            ...
            <label>🔗 LINKS:</label>
              <ul class="links">
                <li>
                  <a 
                  href="https://github.com/4munix/conquers"
                  class="github"
                  target="_blank">
                    conquers
                  </a>
                ...
                <li>
                  <a 
                  href="https://github.com/4munix/conquers-report"
                  class="github"
                  target="_blank">
                    conquers-report
                  </a>
